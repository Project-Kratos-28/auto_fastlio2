...
|---|---|---|
| [`LIVE_MISSION_TEST.md`](LIVE_MISSION_TEST.md) | Full mission: map + tag, loop closure, Nav2 drives to each waypoint (stationary, shadow) | **Current.** Wins on any disagreement |
...
| [`NVBLOX_JAZZY.md`](NVBLOX_JAZZY.md) | Jazzy on the Orin + ZED 2i/nvblox in the local costmap: setup, time sync, run order, limits | New (jazzy-nvblox branch) |
